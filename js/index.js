try {
  ...
  var palette = {
    ...
    yellowgreen: "#738A05"
     ...
     var nodes = [
    { id: 0, name: "Seacon Experience", fill: "green"},
    { id: 1, name: "Bouw", fill: "green", target: [2, 3] },
    { id: 2, name: "Ruimte", fill: "red", target: [] },
    { id: 3, name: "Hardware", fill: "red", target: [14, 15, 18, 4] },
    { id: 4, name: "Showcases", fill: "red", target: [5, 7, 11, 10, 12, 13] },
    { id: 5, name: "3D Printer", fill: "red", target: [] },
    { id: 6, name: "AR", fill: "blue", target: [31, 29, 30, 32] },
    { id: 7, name: "VR", fill: "blue", target: [31, 29, 30, 32] },
    { id: 8, name: "Relatiegeschenk", fill: "red", target: [9, 10] },
    { id: 9, name: "Google Cardboard", fill: "red", target: [] },
    { id: 10, name: "HoloCube", fill: "red", target: [] },
    { id: 11, name: "Warehouse Drone", fill: "red", target: [] },
    { id: 12, name: "PostDrone", fill: "red", target: [] },
    { id: 13, name: "Selfdriving Trucks", fill: "red", target: [] },
    { id: 14, name: "Beamers", fill: "red", target: [17] },
    { id: 15, name: "Licht", fill: "red", target: [17] },
    { id: 16, name: "Tech", fill: "red", target: [14, 15, 17, 18] },
    { id: 17, name: "Controls", fill: "red", target: [] },
    { id: 18, name: "PC", fill: "red", target: [] },
    { id: 19, name: "Content", fill: "green", target: [25, 20, 24, 26] },
    { id: 20, name: "PPT", fill: "lightblue", target: [23, 22, 21] },
    { id: 21, name: "Slides", fill: "lightblue", target: [] },
    { id: 22, name: "Verhaal", fill: "purple", target: [] },
    { id: 23, name: "Sjabloon", fill: "lightblue", target: [] },
    { id: 24, name: "WWW", fill: "lightblue", target: [22] },
    { id: 25, name: "Huisstijl", fill: "purple", target: [20, 23, 24, 27] },
    { id: 26, name: "Portal", fill: "lightblue", target: [27] },
    { id: 27, name: "Experience app", fill: "lightblue", target: [21, 22, 28, 31, 7, 6] },
    { id: 28, name: "360", fill: "lightblue", target: [31, 29, 30] },
    { id: 29, name: "Video", fill: "lightblue", target: [] },
    { id: 30, name: "Stills", fill: "lightblue", target: [] },
    { id: 31, name: "Tour", fill: "lightblue", target: [] },
    { id: 32, name: "Globe", fill: "lightblue", target: [] }
  ];
